<?php
	...
	$GLOBALS['cfg']['site_name'] = 'objectphone';
	...
	$GLOBALS['cfg']['db_main'] = array(
		'host'	=> 'localhost',
		'name'	=> 'objectphone',		# database name
	...
	$GLOBALS['cfg']['twilio_account_sid'] = 'READ-FROM-SECRETS';	
	...
	$GLOBALS['cfg']['sms_method_definitions']= array(
		'methods',
	);	
